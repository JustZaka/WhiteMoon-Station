...
/obj/item/robot_model/engineering
	borg_skins = list(
		...
		"Typhlosion (Technician)" = list(SKIN_ICON_STATE = "typhlosion", SKIN_ICON = CYBORG_ICON_ENG_TALL, SKIN_FEATURES = list(TRAIT_R_UNIQUEWRECK, TRAIT_R_TALL), TALL_HAT_OFFSET) // Zaka.WhiteMoon - Добавлен Тифлосион скин для борга. Заказ @SH1ORI; Спрайтеры @Skadi и @Sir.Soroka; Код @JustZaka (По просьбе)
	)
...
/obj/item/robot_model/janitor
	borg_skins = list(
		...
		"Typhlosion (Maid)" = list(SKIN_ICON_STATE = "typhlosion", SKIN_ICON = CYBORG_ICON_JANI_TALL, SKIN_FEATURES = list(TRAIT_R_UNIQUEWRECK, TRAIT_R_TALL), TALL_HAT_OFFSET) // Zaka.WhiteMoon - Добавлен Тифлосион скин для борга. Заказ @SH1ORI; Спрайтеры @Skadi и @Sir.Soroka; Код @JustZaka (По просьбе)
	)
...
/obj/item/robot_model/medical
	borg_skins = list(
		...
		"Typhlosion (Doc)" = list(SKIN_ICON_STATE = "typhlosion", SKIN_ICON = CYBORG_ICON_MED_TALL, SKIN_FEATURES = list(TRAIT_R_UNIQUEWRECK, TRAIT_R_TALL), TALL_HAT_OFFSET) // Zaka.WhiteMoon - Добавлен Тифлосион скин для борга. Заказ @SH1ORI; Спрайтеры @Skadi и @Sir.Soroka; Код @JustZaka (По просьбе)
	)
...
/obj/item/robot_model/security
	borg_skins = list(
		...
		"Typhlosion (RedSec)" = list(SKIN_ICON_STATE = "typhlosion-red", SKIN_ICON = CYBORG_ICON_SEC_TALL, SKIN_FEATURES = list(TRAIT_R_UNIQUEWRECK, TRAIT_R_TALL), TALL_HAT_OFFSET), // Zaka.WhiteMoon - Добавлен Тифлосион скин для борга. Заказ @SH1ORI; Спрайтеры @Skadi и @Sir.Soroka; Код @JustZaka (По просьбе)
		"Typhlosion (BlueSec)" = list(SKIN_ICON_STATE = "typhlosion-blue", SKIN_ICON = CYBORG_ICON_SEC_TALL, SKIN_FEATURES = list(TRAIT_R_UNIQUEWRECK, TRAIT_R_TALL), TALL_HAT_OFFSET) // Zaka.WhiteMoon - Добавлен Тифлосион скин для борга. Заказ @SH1ORI; Спрайтеры @Skadi и @Sir.Soroka; Код @JustZaka (По просьбе)
	)
